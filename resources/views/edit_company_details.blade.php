                            ...
                            <form action="{{ url('update_company_details/' . $details->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="customer_mobile" name="customer_mobile"
                                        value="{{ $details->customer_mobile }}">
                                </div>
                                <div class="form-group">
                                    <label for="customer_designation">Customer Designation:</label>
                                    <input type="text" class="form-control" id="customer_designation"
                                        name="customer_designation" value="{{ $details->customer_designation }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="employees" id="employees" multiple class="form-control selectpicker">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" <?php echo isset($details->employees) && in_array($user->id, explode(',', $details->employees)) ? 'selected' : ''; ?>>{{ $user->name }}
                                            </option>
