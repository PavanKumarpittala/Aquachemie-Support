         ...
         <div class="row cust_data_form">
                ...
                <div class="col-md-3 margin pull-right no-m-top">
                    <div class="input-group">                      
                     <input type="text" class="form-control no-border-right" id="search_user" placeholder="Search Project...">
  ...
  var BranchListTable = $('#branch_table').DataTable({
        ...
        //   ],
         ...
         "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            var action1 = '<td><a data-toggle="modal" data-target="#view_description" class="btn btn-primary" data-id="'+aData['id']+'" style="color: #fff;" onclick="viewDescription('+aData['id']+');">View Description</a>&nbsp&nbsp';
               action1 += '</td>';
