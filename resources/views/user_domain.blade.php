            ...
            <div class="col-md-12 user-right">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 style="color:#A04000">Users Domain List</h4>
                        ...
                        <div class="row cust_data_form">
                            ...
                            <div class="col-md-3 pull-right">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#user_domain"
                                    type="submit">Add User Domain</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="update_user_domain" action="javascript:void(0)" method="POST">
                        ...
                        <button type="update" class="btn btn-primary" name="button">Update</button>
                    </form>
                </div>
        ...
        $(document).ready(function() {
            var BranchListTable = $('#branch_table').DataTable({
                ...
                "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                    ...
                    var action1 =
                        '<td class="admin-center"><a  data-toggle="modal" data-target="#update_users_domain" title="Edit" onclick="editUserDomain(' +
                        aData['id'] +
                    ...
                    action1 += '<a data-toggle="modal" data-target="#delete_domain"  title="' +
                        statusData + '" onclick="deleteDomain(' + aData['id'] + ',' + aData['status'] +
