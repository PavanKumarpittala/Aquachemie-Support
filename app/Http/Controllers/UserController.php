...
class UserController extends Controller
{
    ...
    public function addEmployees(Request $request)
    {
      ...
      $data = $request->all();
       $params = array(
                      ...
                      'name' => $request['employee_full_name'],
                      'department' => $request['emploee_department'],
        ...
        if ($users_list) {
          ...
          // Send Welcome Email with Login, UserPassword
          $data = [
              'name' =>  $request['employee_full_name'],
              'email' =>  $personalEmail,
          ...
          // Mail::send('emails.employee-registration', $data, function ($message) use ($personalEmail) {
          //     $message->to($personalEmail)->subject('Welcome to Aquachemie, Employee Information');
          // });
        }
  ...
  public function deleteUser($id,$status)
  {
    ...
    $delete_user = array('status'   =>$update_status,
                        'updated_at' => date('Y-m-d H:i:s')
                        );
