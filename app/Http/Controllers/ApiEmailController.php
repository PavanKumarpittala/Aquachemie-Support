...
{
    const SUPPORT_EMAIL_CONFIG = 'it.aquachemie@gmail.com';
    const DEFAULT_USEREMAIL_CONFIG = 'info@aquachemie.com';
    const DEFAULT_USEREMAIL_NAME = 'Aquachemie Info';
    ...
    public function getOutlookMails()
    {
        ...
        $client = $cm->make([
            ...
            'encryption'    => 'ssl',
            'validate_cert' => false,
            'username'      => SELF::SUPPORT_EMAIL_CONFIG,
            'password'      => 'idewvgrckwpckoes',
            'protocol'      => 'imap',
        ]);
    ...
    public function supportEmail()
    {
        ...
        $supportEmail = SELF::SUPPORT_EMAIL_CONFIG;
    ...
    public function sendEmailToClient($client_email, $user_email, $ticket_id, $subject_ticketid, $username, $mail_message, $attachments = [], $manager_email = null, $cc_email_address = [], $support_email, $to_address = [])
    {
        ...
        $support_email = SELF::SUPPORT_EMAIL_CONFIG;
        $cc_final_mail = [];
